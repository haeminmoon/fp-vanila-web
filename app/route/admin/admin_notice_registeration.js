    ...
    go(
        ...
        async b => {
            ...
            return go(
                targetUserList,
                map(a => {
                    if (a.notification_list === null) a.notification_list = {[hsms] : {attr : notification_contents.attr, id : notification_contents.id, name : notification_contents.name, read : false}};
                    else Object.assign(a.notification_list, {[hsms] : {attr : notification_contents.attr, id : notification_contents.id, name : notification_contents.name, read : false}});
                    return a;
                }),
                map(b => {
